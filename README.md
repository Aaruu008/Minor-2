...
Source Code: (https://github.com/Aaruu008/Movies-Shows-PodcastRecomendationSystem.git)
...
2. Install all the libraries mentioned in the [requirements.txt][(https://github.com/Aaruu008/Movies-Shows-PodcastRecomendationSystem.git/requirements.txt)) file with the command pip install -r requirements.txt
